...
* Install and Configure Apache/Nginx for redirecting 80/443 port to meteor app (I explain only for Nginx case)
    ...
    *** We can check listening port status by `sudo lsof -i -P -n | grep LISTEN` command and change the ports *** 
    ...
    #    server_name *.ganda.app ganda.app; # the domain on which we want to host the application. Since we set "default_server" previously, nginx will answer all hosts anyway.
...
* How to build the production app
    ...
    *** Here we need to use node.js 8.17.0 to do `npm install` on production app ***
    ...
    `MONGO_URL="mongodb://envent:Env~321enT@cluster0-shard-00-00-h0lqq.mongodb.net:27017,cluster0-shard-00-01-h0lqq.mongodb.net:27017,cluster0-shard-00-02-h0lqq.mongodb.net:27017/ganda-app?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true&w=majority" ROOT_URL="https://admin.ganda.app" METEOR_SETTINGS='{ "awsBucket": "envent.ly", "awsAccessKeyId": "AKIAIGILMACFBZCKBKTQ", "awsSecretKey": "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", "awsRegion": "ap-southeast-2", "loggly":{ "token": "a52095ba-00bf-4d56-9ef9-98ca68edc122", "subdomain": "envently", "auth": { "username": "app", "password": "App123" }, "json": "true" }, "private":{ "smtp" : { "username": "envently@envent.com.au", "password": "EnvEntly123@#$", "server":  "smtp.gmail.com", "port": 587 } }, "sendgrid": { "SENDGRID_API_KEY": "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" }, "public": { "globalURL": "ganda.app", "mapboxglKey": "pk.eyJ1IjoiZW52ZW50IiwiYSI6ImNqMTJ3MG81czAwYmszM28yNHlxNmFrYnYifQ.XH3Z4-OILdPbG_wCna1g-Q", "prodSensisKey":"hjaqehsymv8rt8k62v698ghp", "devSensisKey":"6q56cxjyygzktfkyrtahadnw", "prodSensisUrl":"https://api.sensis.com.au/v1/prod/", "devSensisUrl":"http://api.sensis.com.au/v1/test/", "isLocal": false, "userAppActions": { "appStart":"app start", "appLoaded":"app loaded", "sensisQuery":"sensis query", "sensisResult":"sensis result", "localQuery":"local query", "localResult":"local result", "mapRender":"map render", "mapRendered":"map rendered", "mainMenuOpened":"main menu opened", "mainMenuItemSelected":"main menu item selected", "subMenuItemSelected":"sub menu item selected", "markerPressed":"marker pressed", "detailsButtonPressed":"details button pressed", "directionsButtonPressed":"directions button pressed", "externalLinkPressed":"External link pressed", "listMenuSelected":"list menu item selected", "languageSelected":"language selected"  } } }' node main.js`
